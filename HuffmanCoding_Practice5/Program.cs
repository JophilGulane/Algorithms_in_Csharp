namespace HuffmanCoding_Practice5
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int variableWidthTable = frequencies.Sum(kvp => huffmanCoding[kvp.Key].Length);
            int variableWIdthCost = frequencies.Sum(kvp => kvp.Value * huffmanCoding[kvp.Key].Length);
